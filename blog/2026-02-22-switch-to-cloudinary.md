...
- 📖 Improved Getting Started Documentation  
  Includes Development.md and ReadMe.md

- 🌉 Switched from PnP to Node Modules  
  This will help with future project maintenance
  Yarn V4 Node Modules makes it easier for
  IDE Editors and other utilities to manage the project

- 🌇 Switched End Line setting  
